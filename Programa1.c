...
void showRecords (){
		...
		char str2[32];
		char str3[32];
		//sprintf(str1, "%c%c%c: %d \r\n",player1.nickName[0],player1.nickName[1],player1.nickName[2],score);
		//sprintf(str2, "%c%c%c: %d \r\n",player2.nickName[0],player2.nickName[1],player2.nickName[2],score);
		//sprintf(str3, "%c%c%c: %d \r\n",player3.nickName[0],player3.nickName[1],player3.nickName[2],score);
